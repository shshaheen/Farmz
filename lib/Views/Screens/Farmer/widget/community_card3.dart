...
class CommunityCard3 extends StatelessWidget {
  CommunityCard3({super.key});
      ...
      child: Row(
        children: const [
          ...
          Text("12 Members"),
            ...
            // Description
            const Text(
              "Focused on implementing agricultural technology and innovative farming methods.",
            ...
            Row(
              children: [
                for (var label in ["Technology","Innovation","Education"])
                  Container(
            ...
            Row(
              children: [
                memberChip("DL", "David Lee", online: true),
                const SizedBox(width: 12),
                memberChip("SM", "Sarah Miller"),
              ],
            ),
            const SizedBox(height: 8),
            Row(
              children: [
                memberChip("SJ", "Stephen Johnson"),
                const SizedBox(width: 12),
                const CircleAvatar(
